...
# ╔═╡ 0e6c45f7-1d2d-4efa-9519-28e26da55e71
begin
    using Plots
    using LaTeXStrings
...
# ╔═╡ 4c8a7230-71df-48cb-943e-fe1ef45adc5a
function cycloid_ode(u, p, x)
    f  = u[1]
    df = u[2]
    du = [df, -(1 + df^2) / (2f)]
    return du
...
# ╔═╡ 131469d0-64d2-46c5-bde2-4c394ad3ff80
begin
    u0 = [-1, 0.4]
    xspan = (0, 1.0)

    prob = ODEProblem(cycloid_ode, u0, xspan)
...
# ╔═╡ a71f4988-fe09-44f6-92e7-8fb1da64ae9e
sol.t[end-10:end]

# ╔═╡ d9c03d1d-ce7a-4193-a2cf-740777c85378
function my_shooting(df0)
    u0 = [-1, df0]
    xspan = (0, 1.0)
...
# ╔═╡ b0a0116f-e54d-4ad9-847c-3e7e8306cc49
plot(range(0.375, 0.4, 201),
     my_shooting.(range(0.375, 0.4, 201)))

# ╔═╡ 7ec8af75-878d-40a5-8131-33c1c5ea22c5
sol_0[end]

# ╔═╡ 2872445e-ffce-4fd1-b973-423c7c1664ae
g = 9.81

# ╔═╡ bf67c217-dd1b-45dc-94e4-fd93de47d7c7
F(f, df, h = 1) = ((1+df^2)/(2*g*(h-f)))^0.5

# ╔═╡ 35fd416f-287b-455b-b0aa-30e253d9dc7f
...
# ╔═╡ 49f17d44-9e7f-4386-9b1c-5b9a741f82b9
function T(F, f, df, x)
    # x = range(dx, L, step = dx)
...
# ╔═╡ 7d409eea-f03c-42b6-8f61-4a5188adafb8
...
# ╔═╡ 4b1ee460-3300-4b42-b423-fb629eae57da
build_parabola(x) = x^2

# ╔═╡ 9a4112b0-37c8-4e84-a351-049c55205d5d
begin
...
# ╔═╡ dd67551c-9780-4472-8bd5-ef8bc37e89a7
plot(y1s, T_array, 
...
manifest_format = "2.0"
project_hash = "8f98e5d9a6295378636ada9894a504f65384792f"
...
git-tree-sha1 = "a54e5ce78be1955debb3a61625ed217849b9cc0a"
