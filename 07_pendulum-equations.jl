...
# ╔═╡ 8f99fc14-06a9-11f1-a54a-61b4e5e92f0f
using Symbolics, Plots, DifferentialEquations, Latexify, OrdinaryDiffEq

# ╔═╡ fd4546d6-6a87-45fe-87d9-c71e68c9bfd3
using DiffEqCallbacks

# ╔═╡ d32e183c-3e12-4827-8d74-071d0e8886d5
md"""# Using Julia to create, solve, and visualize Pendulum motion
...
![model of the simple pendulum angle is measured from vertical position and gravity is pointing down](https://raw.githubusercontent.com/cooperrc/dynamics/refs/heads/main/images/pendulum.svg)
...
# ╔═╡ 911fdd5e-a242-4d2a-a930-5a4168a930d4
begin
@variables t m L g
...
# ╔═╡ b35fbaad-0a89-4bc3-be10-150632f5ff0a
md"""## Create the equation of motion
...
# ╔═╡ ac4059ac-b7d5-43f1-ba3c-cb805a3b3681
begin
...
# ╔═╡ 0556f196-aeab-49f9-87b8-6b678a4f88b0
md"""## Lagrange equation of motion
...
# ╔═╡ d8e9859c-ae6e-4486-ba90-ec6eda3d86c4
ode_symbolic = solve_for(EL_equation, D(D(θ)))# isolate θ̈ symbolically

# ╔═╡ 361a9513-e7cc-4e82-8f6f-077fc645806e
begin
...
# ╔═╡ bb3539fb-8919-4341-9b8b-3bdb93f4ec5f
...
# ╔═╡ 752ea4b8-f498-46df-8fb6-072b3dae4c01
begin
...
# ╔═╡ ebe66c93-a8a5-4ecf-bf9b-e2ab733c95bb
begin
...
# ╔═╡ 2f00e234-1768-4744-a826-ec0f6c4d4147
md"""# Add Mass and Moment and Torque """

# ╔═╡ fea6c2b2-ba30-4e2b-b58b-d11dc252bbc5
m_bob = 2.0  # kg

# ╔═╡ 9d1c2bc2-2370-45c4-ad0a-d7db7054db94
θ_vals = sol[1,:]

# ╔═╡ b9c7cdcd-d3e1-41c5-962d-efbfbb48cc17
ω_vals = sol[2,:]

# ╔═╡ 7d0ca31b-e2a8-44fb-8e90-59e5042fc40f
t_vals = sol.t

# ╔═╡ 4d7035d5-719e-4f88-a95f-a50df42ed488
g_val, L_val = parameters

# ╔═╡ c0f15cf0-6e6a-4149-834d-bbfdeba5645c
I = m_bob * L_val^2

# ╔═╡ 6343c958-f006-40ef-939c-164b47d5c62e
angular_momentum = I .* ω_vals

# ╔═╡ 239a934c-41d6-42a7-9e32-c3015e39a3fd
torque = -m_bob * g_val * L_val .* sin.(θ_vals)

# ╔═╡ 8c1a0086-6666-4a20-b9ee-06145eb8d045
impulse = cumsum(torque[1:end-1] .* diff(t_vals))

# ╔═╡ 6f485484-3b69-48b2-a309-31600569710e
impulse2 = vcat(impulse, impulse[end])

# ╔═╡ bcf64664-85a6-46a5-bf32-4541d49b2d66
plot(t_vals, angular_momentum, label="Angular Momentum", xlabel="Time", ylabel="L")

# ╔═╡ 5932bc8c-7ab4-45a9-91c2-f1e74e2c0892
plot!(t_vals, impulse2, label="Angular Impulse")

# ╔═╡ 86432b2c-5b9d-4f31-bb74-aaa4849b2cc7
md"""# Add Impulse """

# ╔═╡ 120334d9-b95d-40b9-9bd0-845e11f4b096
function kick!(integrator)
    integrator.u[2] += 2.0  
end

# ╔═╡ 16d79828-9bb9-48e3-bdc5-a8362aeb5b6c
cb = PresetTimeCallback([3.0], kick!)

# ╔═╡ 2dcdc574-c958-4053-91e6-a04568c97ab6
prob_kick = ODEProblem(pendulum_ode!, initial_state, time_span, parameters)

# ╔═╡ f991a4de-0262-41c1-9360-2c75001aeed9
sol_kick = solve(prob_kick; callback=cb, reltol=1e-6)

# ╔═╡ 06764a81-c682-4565-9d3c-2095937ba5eb
plot(sol.t, sol[1,:], label="Normal")

# ╔═╡ 3ee15ca8-a53e-4c4b-91db-2e0702743f5c
plot!(sol_kick.t, sol_kick[1,:], label="With Kick")

# ╔═╡ 9f0a38c1-2bf2-4ff7-abbd-7a8a63b44938
md"""# Add Space Plot """

# ╔═╡ 803cab7d-720d-4dd9-a2a5-278fc0a1436b
plot(sol[1,:], sol[2,:],
     xlabel="θ",
     ylabel="ω",
     title="Phase Space",
...
# ╔═╡ 1cd60d3a-1e9a-4340-a3ca-140b8fdfa256
plot!(sol_kick[1,:], sol_kick[2,:],
      label="With Kick")

# ╔═╡ 1e687d07-722e-43c1-b9dd-8c3648115fb0


# ╔═╡ 3f0ae44b-5970-45db-94a9-7dae29fa369b
energy = 0.5 .* m_bob .* L_val^2 .* ω_vals.^2 .+
         m_bob .* g_val .* L_val .* (1 .- cos.(θ_vals))

# ╔═╡ b86581bd-d6b7-4f0e-a881-7a94b867c299
plot(t_vals, energy, xlabel="Time", ylabel="Energy", label="Total Energy")
...
manifest_format = "2.0"
project_hash = "19442f4bd9f2771215a80c8175417e30378c9bfd"
