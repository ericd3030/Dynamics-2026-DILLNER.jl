...
# ╔═╡ 534ae6d0-1421-11f1-afcc-2b4d6ec95d19
using DifferentialEquations

# ╔═╡ e2cc8703-7a3a-48fa-87d5-f3072faf8e7b
using Plots

# ╔═╡ dcbe5ed9-cbcf-46fc-803d-ed47f9b5d23c
g = 9.81

# ╔═╡ af09c26f-9585-4c76-985f-34694fc77fda
md"# Find Velocity of Block 1 if m2 = m3 and m3 = m1+m2"

# ╔═╡ ff6e3e3f-b22d-44fb-b814-43b74b15f5e2
function pulley_reduced!(du,u,p,t)
    y1, v1 = u
    m1, m2, m3 = p
    
    # Single independent equation of motion
    a1 = g*(m2 + m3 - m1) / (m1 + (m2 + m3)/4)
    
    du[1] = v1
    du[2] = a1
end

# ╔═╡ 175b0224-2949-488d-8f6a-939d28538c52
# ╠═╡ disabled = true
#=╠═╡
# Example: make block 1 stationary
m1 = 2.0
  ╠═╡ =#

# ╔═╡ 42818e56-c474-4083-a6f9-41e2d3d42476
# ╠═╡ disabled = true
#=╠═╡
m2 = 1.0
  ╠═╡ =#

# ╔═╡ 19c4b059-71fe-4444-a3a7-bcb288ab49b3
# ╠═╡ disabled = true
#=╠═╡
m3 = 1.0   # m1 = m2 + m3
  ╠═╡ =#

# ╔═╡ 0b228a6c-5485-4e23-8786-3520f6733c17
# ╠═╡ disabled = true
#=╠═╡
u0 = [0.0, 0.0]
  ╠═╡ =#

# ╔═╡ 0dc93459-d928-441b-a717-3d5f40c8afbc
# ╠═╡ disabled = true
#=╠═╡
tspan = (0.0,0.5)
  ╠═╡ =#

# ╔═╡ 678e4c57-bc77-4461-9cf0-bbf2b29a5a17
# ╠═╡ disabled = true
#=╠═╡
prob = ODEProblem(pulley_reduced!,u0,tspan,(m1,m2,m3))
  ╠═╡ =#

# ╔═╡ 9006c95e-3071-4496-befc-ac3c7a999fa5
# ╠═╡ disabled = true
#=╠═╡
sol = solve(prob)
  ╠═╡ =#

# ╔═╡ d0e53c32-d029-4546-a151-3975ba04410c
md"# Trying Diffrent Masses "

# ╔═╡ d88d45df-4088-4515-9431-bfb1079b9f84
function pulley_reduced!(du,u,p,t)
    y1, v1 = u
    m1, m2, m3 = p
...
# ╔═╡ 69c2c3e2-91d3-49bb-9919-acb9b3555de3
# Recover other positions using constraint
C = 0.0  # choose reference constant

# ╔═╡ f01e2215-bc2f-4b73-9f99-51be5abe5597
md"# Velocity & Acceleration for diffrent masses "

# ╔═╡ 29411485-4db3-4375-b614-a719d5deaaf9
function pulley_reeeduced!(du,u,p,t)
    y1, v1 = u
    m1, m2, m3 = p
...
# ╔═╡ 8d3f25ff-b5e5-4244-af79-2f4147035c2d
println("Final velocity of block 1: ", sol[end][2])

# ╔═╡ 5b154546-1343-4871-b99b-8ada3b6ab092
# ╠═╡ disabled = true
#=╠═╡
y1 = sol[1,:]
  ╠═╡ =#

# ╔═╡ 1f69144f-d21b-448d-8e49-b1611138eda0
# ╠═╡ disabled = true
#=╠═╡
y2 = C .- 2y1 .+ 0.5*(m3-m2)  # small relative offset
  ╠═╡ =#

# ╔═╡ 5a93fda0-5cb7-4771-98f9-5a67ef2626e1
# ╠═╡ disabled = true
#=╠═╡
y3 = C .- 2y1 .- 0.5*(m3-m2)
  ╠═╡ =#

# ╔═╡ 9c4c97bc-74e1-4752-bb57-f5ad8ef212b7
v1 = sol[2,:]  # velocity of mass 1

# ╔═╡ ad594bca-5a32-4b87-86ae-b0151f7ad764
v2 = -2 .* v1 ./ 2

# ╔═╡ 58cb29bf-f740-4584-8bdf-fc0c8001754d
v3 = -2 .* v1 ./ 2

# ╔═╡ 3f85677c-c63c-414c-b05b-2d43b862fa0e
println("Final velocities:")

# ╔═╡ 4fead0f9-44f2-4a53-84a7-f8ad66791172
println("v1 = ", v1[end])

# ╔═╡ 80a740da-9b52-4aa7-92eb-e9a72ca44170
println("v2 = ", v2[end])

# ╔═╡ 484c3fe2-9b70-4e22-8fa5-8c10f1a846aa
println("v3 = ", v3[end])

# ╔═╡ 1eba1eb8-26a6-4d0e-845c-b17690460cea
a1 = g*(m2 + m3 - m1) / (m1 + (m2 + m3)/4)

# ╔═╡ 5ea9b822-e7c5-4d26-b3cd-70bbc0a5d960
# From constraint: 2a1 + a2 + a3 = 0
# For symmetric case:
a2 = -a1

# ╔═╡ be0b87e0-44b7-49bf-be81-271d3e92df49
a3 = -a1

# ╔═╡ 91ae1539-798e-4b73-ab34-6b7db3f5b348
println("Accelerations:")

# ╔═╡ 77712458-c0dd-4cdd-8305-01515be019b2
println("a1 = ", a1)

# ╔═╡ 4addb6dd-841f-42ef-b209-765837e2b3f7
println("a2 = ", a2)

# ╔═╡ 9c3c04a8-6add-46a3-9f42-012f39ccdde5
println("a3 = ", a3)

# ╔═╡ d1ab673e-f811-4a2d-9b82-24de29741331
m1 = 10

# ╔═╡ 83397087-84d2-4fd7-bce6-9d936742b892
# ╠═╡ disabled = true
#=╠═╡
tspan = (0.0,1.0)
  ╠═╡ =#

# ╔═╡ 227a57de-cb53-47a6-a3fc-bb8337555ad3
# ╠═╡ disabled = true
#=╠═╡
u0 = [0.0, 0.0]
  ╠═╡ =#

# ╔═╡ 1b392f57-c2a7-47ba-903a-19946ca0eb49
m2 = 5

# ╔═╡ 656bbb0e-da51-4cef-b027-bb345880c7a3
# ╠═╡ disabled = true
#=╠═╡
m2 = 1.2
  ╠═╡ =#

# ╔═╡ 29ebca28-6e9b-43ba-8210-c0d652bd1b71
# ╠═╡ disabled = true
#=╠═╡
prob = ODEProblem(pulley_reduced!,u0,tspan,(m1,m2,m3))
  ╠═╡ =#

# ╔═╡ af8ff8bc-ff76-4dab-bd33-57c0160f6e1f
sol = solve(prob)

# ╔═╡ 2cd0794a-a483-4c21-a782-b5885e080dc9
prob = ODEProblem(pulley_reeeduced!,u0,tspan,(m1,m2,m3))

# ╔═╡ e9d8129f-5e22-42a9-9cfb-ceca7a4a9aea
# ╠═╡ disabled = true
#=╠═╡
# Try different mass cases:
m1 = 2.0
  ╠═╡ =#

# ╔═╡ 57b4c4f6-6af0-45df-9b6c-e4ae2053df13
# ╠═╡ disabled = true
#=╠═╡
sol = solve(prob)
  ╠═╡ =#

# ╔═╡ d89a9b28-4128-43d3-9d92-579db0273a29
m3 = 1

# ╔═╡ ca122f57-82b7-4f35-9573-aeca118ae645
u0 = [0.0, 0.0]

# ╔═╡ 823d4cc6-f625-460f-afe0-78b872330fe4
# ╠═╡ disabled = true
#=╠═╡
m3 = 0.8  
  ╠═╡ =#

# ╔═╡ 50a309e9-dfde-4eb8-924d-8da057aa5dd1
tspan = (0.0,2.0)
...
manifest_format = "2.0"
project_hash = "1f8d1aae5bf70fd3433f61b6956aa7243bed80af"
